...
def main():
    ...
    parser.add_argument("--in_path", type=str, default='/projectnb/ec522/students/huatong/text_data/text_dataall/', help='Folder to save the low quality image',)
    parser.add_argument("--out_path", type=str, default='/projectnb/ec522/students/huatong/PiRN-main/assets/inference_output', help='Folder to save the restored results',)
    args = parser.parse_args()

    cfg_path = '/projectnb/ec522/students/huatong/PiRN-main/assets/configs/configuration.yaml'
